...
def avatar_url(user, size=settings.AVATAR_DEFAULT_SIZE):
    ...
    if settings.AVATAR_GRAVATAR_BACKUP:
        ...
        if settings.AVATAR_GRAVATAR_DEFAULT:
            try:
                l = letter( user.first_name )
                d = settings.AVATAR_GRAVATAR_DEFAULT % { 'letter': l }
            except:
                d = settings.AVATAR_GRAVATAR_DEFAULT % { 'letter': '1' }
    ...
    try:
        l = letter( user.first_name )
        return settings.AVATAR_DEFAULT_URL % { 'letter': l }
    except:
        return settings.AVATAR_DEFAULT_URL % { 'letter': '1' }
